...
func (p EDAMErrorCode) String() string {
	...
	case EDAMErrorCode_OPENID_ALREADY_TAKEN:
		return "OPENID_ALREADY_TAKEN"
	case EDAMErrorCode_INVALID_OPENID_TOKEN:
		return "INVALID_OPENID_TOKEN"
	case EDAMErrorCode_USER_NOT_ASSOCIATED:
		return "USER_NOT_ASSOCIATED"
	case EDAMErrorCode_USER_NOT_REGISTERED:
		return "USER_NOT_REGISTERED"
	case EDAMErrorCode_USER_ALREADY_ASSOCIATED:
		return "USER_ALREADY_ASSOCIATED"
	case EDAMErrorCode_ACCOUNT_CLEAR:
		return "ACCOUNT_CLEAR"
	case EDAMErrorCode_SSO_AUTHENTICATION_REQUIRED:
		return "SSO_AUTHENTICATION_REQUIRED"
	}
	return "<UNSET>"
}
...
func EDAMErrorCodeFromString(s string) (EDAMErrorCode, error) {
	...
	case "OPENID_ALREADY_TAKEN":
		return EDAMErrorCode_OPENID_ALREADY_TAKEN, nil
	case "INVALID_OPENID_TOKEN":
		return EDAMErrorCode_INVALID_OPENID_TOKEN, nil
	case "USER_NOT_ASSOCIATED":
		return EDAMErrorCode_USER_NOT_ASSOCIATED, nil
	case "USER_NOT_REGISTERED":
		return EDAMErrorCode_USER_NOT_REGISTERED, nil
	case "USER_ALREADY_ASSOCIATED":
		return EDAMErrorCode_USER_ALREADY_ASSOCIATED, nil
	case "ACCOUNT_CLEAR":
		return EDAMErrorCode_ACCOUNT_CLEAR, nil
	case "SSO_AUTHENTICATION_REQUIRED":
		return EDAMErrorCode_SSO_AUTHENTICATION_REQUIRED, nil
	}
